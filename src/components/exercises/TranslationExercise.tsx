    ...
    <View style={styles.container}>
      ...
      {disabled && (
        <Text style={styles.correctAnswer}>
          Correct answer: {exercise.correctAnswer as string}
        </Text>
      )}
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  input: {
    borderWidth: 2, borderColor: COLORS.gray[200], borderRadius: RADIUS.lg,
    padding: SPACING.md, fontSize: FONT_SIZE.lg, color: COLORS.midnight[800],
    backgroundColor: COLORS.white,
  },
  inputDisabled: { backgroundColor: COLORS.gray[100] },
  submitBtn: {
    backgroundColor: COLORS.fire[500], padding: SPACING.md, borderRadius: RADIUS.lg,
