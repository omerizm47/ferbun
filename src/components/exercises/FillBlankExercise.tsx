...
interface Props { exercise: Exercise; onAnswer: (correct: boolean, opts?: { exact?: boolean }) => void; disabled: boolean; }
  ...
  return (
    <KeyboardAvoidingView style={styles.container} behavior={Platform.select({ ios: 'padding', android: 'height' })}>
      ...
      <TextInput
        ...
        placeholder={t.exercises.fillBlank}
...
const makeStyles = (c: ThemeColors) => StyleSheet.create({
  container: { flex: 1 },
  input: { borderWidth: 1.5, borderColor: c.gray[200], borderRadius: RADIUS.lg, padding: SPACING.md, fontSize: FONT_SIZE.lg, color: c.midnight[800], backgroundColor: c.white, ...SHADOWS.sm },
