...
const E: Record<string, Exercise[]> = {
  ...
  l1_3: [
    ...
    { id: 'e16', lessonId: 'l1_3', type: 'multiple_choice', questionKu: 'Ne sar e.', questionEn: 'What does this sentence mean?', options: ['It is not cold.', 'It is cold.', 'It is very cold.', 'Is it cold?'], correctAnswer: 'It is not cold.', explanation: '"Ne" goes before what is negated.', questionTr: 'Bu cümle ne demek?', optionsTr: ['Soğuk değil.', 'Soğuk.', 'Çok soğuk.', 'Soğuk mu?'], correctAnswerTr: 'Soğuk değil.', explanationTr: '"Ne" olumsuzlanan şeyin önüne gelir.', order: 4 },
