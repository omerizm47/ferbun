...
export const CKB_GLOSS_PROVENANCE =
  ...
  'Grammar with Selected Readings", at the page named in that entry\'s src. The Turkish gloss ' +
  'is not his: it is a translation of that English gloss, authored for this app, and it carries ' +
  'no locator, because Thackston glosses in English only. No native speaker has reviewed any of ' +
  'it, neither the forms nor the glosses.';
...
export const CKB_VOCAB_THEMES: SoraniVocabTheme[] = [
  { id: 'family', label: 'Family & People', labelKu: 'binemalle', labelTr: 'Aile & İnsanlar', icon: 'people-outline', color: '#1F8A4C', src: 'THK06:171' },
];
